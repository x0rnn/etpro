...
-- x0rnn: added megaslap, addtime, autoslap, shuffledamage, shuffledamage_restart
...
function et_ConsoleCommand()
        ...
        if et.trap_Argv(0) == "renameplayer" then
   		if et.trap_Argc() ~= 3 then
         	...
         	if string.len(et.trap_Argv(1)) < 3 then
				...
				if inSlot(et.trap_Argv(1)) ~= nil then
	...
	if et.trap_Argv(0) == "shuffledamage_restart" then
		local axisdmg = 0
		local alliesdmg = 0
		local damages = {}
